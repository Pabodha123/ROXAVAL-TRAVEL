...
const hotelsSeed = [
  { name: 'Water Garden Sigiriya', destination: 'Sigiriya', category: 'Luxury', starRating: 5, address: 'Inamaluwa, Sigiriya', description: 'A lush lagoon resort in the shadow of the Lion Rock, with private garden villas and open-air dining.', images: ['/f1dc4405-8788-4026-86f6-8dcd6433d54c.jpg'], amenities: ['Pool', 'Spa', 'Free WiFi', 'Restaurant'], roomTypes: [{ name: 'Garden Villa', maxOccupancy: 2, pricePerNight: 180, amenities: ['Private terrace', 'Air conditioning'] }] },
  { name: 'Kandy Lake Residence', destination: 'Kandy', category: 'Deluxe', starRating: 4, address: 'Sangaraja Mawatha, Kandy', description: 'Boutique lakeside stay with sweeping views over Kandy Lake and the Temple of the Tooth.', images: ['/e9d77ac4-d145-4b73-befe-f35b121bcb9f.jpg'], amenities: ['Lake view', 'Free WiFi', 'Restaurant'], roomTypes: [{ name: 'Lake View Room', maxOccupancy: 2, pricePerNight: 110, amenities: ['Balcony', 'Air conditioning'] }] },
  { name: 'Ella Flower Garden Resort', destination: 'Ella', category: 'Boutique', starRating: 4, address: 'Passara Road, Ella', description: 'A hillside retreat surrounded by tea gardens with panoramic views of Ella Gap.', images: ['/28226e86-8f8e-4d79-b1fa-e1c155bc045c.jpg'], amenities: ['Mountain view', 'Pool', 'Free WiFi'], roomTypes: [{ name: 'Valley View Cottage', maxOccupancy: 2, pricePerNight: 95, amenities: ['Private balcony'] }] },
  { name: 'Cinnamon Wild Yala', destination: 'Yala', category: 'Resort', starRating: 5, address: 'Palatupana, Yala', description: 'Chalets bordering Yala National Park, built for waking up to the sound of the wild.', images: ['/60b4c194-d3e8-44d7-8a8c-b9d58a908c56.jpg'], amenities: ['Pool', 'Safari desk', 'Restaurant'], roomTypes: [{ name: 'Chalet Room', maxOccupancy: 2, pricePerNight: 160, amenities: ['Garden view', 'Air conditioning'] }] },
  { name: 'Jetwing Lighthouse Galle', destination: 'Galle', category: 'Luxury', starRating: 5, address: 'Dadella, Galle', description: 'A clifftop icon overlooking the Indian Ocean, designed by renowned architect Geoffrey Bawa.', images: ['/a11c5b41-970d-4c2e-bc21-b12bbb96bc44.jpg'], amenities: ['Ocean view', 'Pool', 'Spa'], roomTypes: [{ name: 'Ocean View Room', maxOccupancy: 2, pricePerNight: 210, amenities: ['Sea view', 'Minibar'] }] },
  { name: 'Mirissa Beach Villas', destination: 'Mirissa', category: 'Resort', starRating: 4, address: 'Beach Road, Mirissa', description: 'Palm-shaded villas steps from the sand, close to Mirissa’s whale-watching harbour.', images: ['/5173712e-19bd-4ede-810a-b1fd443e9ef1.jpg'], amenities: ['Beachfront', 'Pool', 'Restaurant'], roomTypes: [{ name: 'Beachfront Villa', maxOccupancy: 2, pricePerNight: 140, amenities: ['Sea view', 'Outdoor shower'] }] },
  { name: 'Taru Villas Bentota', destination: 'Bentota', category: 'Boutique', starRating: 4, address: 'River Avenue, Bentota', description: 'A riverside boutique villa blending colonial charm with tropical garden courtyards.', images: ['/09458834-a156-4b05-8dc9-c0c7c2c90a20.jpg'], amenities: ['River view', 'Pool', 'Free WiFi'], roomTypes: [{ name: 'Garden Room', maxOccupancy: 2, pricePerNight: 105, amenities: ['River view'] }] },
];
...
const activitiesSeed = [
  {
    name: 'Wildlife Safari', category: 'Wildlife', image: '/1b2aae1b-d37a-47fe-9479-1d17002debd6.jpg',
    gallery: ['/1b2aae1b-d37a-47fe-9479-1d17002debd6.jpg', '/60b4c194-d3e8-44d7-8a8c-b9d58a908c56.jpg'],
  ...
  {
    name: 'Scenic Train Journey', category: 'Scenic', image: '/ded68c06-c3a1-4dfa-a417-e025e5868f60.jpg',
    gallery: ['/ded68c06-c3a1-4dfa-a417-e025e5868f60.jpg', '/28226e86-8f8e-4d79-b1fa-e1c155bc045c.jpg'],
  ...
  {
    name: 'Whale Watching', category: 'Water Sports', image: '/13d86629-a667-4693-8520-ac7db2e2c8c7.jpg',
    gallery: ['/13d86629-a667-4693-8520-ac7db2e2c8c7.jpg', '/5173712e-19bd-4ede-810a-b1fd443e9ef1.jpg'],
  ...
  {
    name: 'Tea Plantation Tours', category: 'Culture', image: '/470f58a2-b8ec-4c53-b2fe-62c6f0cbb506.jpg',
    gallery: ['/470f58a2-b8ec-4c53-b2fe-62c6f0cbb506.jpg', '/e9d77ac4-d145-4b73-befe-f35b121bcb9f.jpg'],
  ...
  {
    name: 'Sigiriya Rock Climb', category: 'Adventure', image: '/f1dc4405-8788-4026-86f6-8dcd6433d54c.jpg',
    gallery: ['/f1dc4405-8788-4026-86f6-8dcd6433d54c.jpg', '/8e639092-b4b2-41f6-ad69-0a4e0017609a.jpg'],
  ...
  {
    name: 'Temple of the Tooth Tour', category: 'Culture', image: '/e9d77ac4-d145-4b73-befe-f35b121bcb9f.jpg',
    gallery: ['/e9d77ac4-d145-4b73-befe-f35b121bcb9f.jpg'],
  ...
  {
    name: 'Galle Fort Walking Tour', category: 'Culture', image: '/a11c5b41-970d-4c2e-bc21-b12bbb96bc44.jpg',
    gallery: ['/a11c5b41-970d-4c2e-bc21-b12bbb96bc44.jpg'],
  ...
  {
    name: 'Little Adam’s Peak Hike', category: 'Adventure', image: '/28226e86-8f8e-4d79-b1fa-e1c155bc045c.jpg',
    gallery: ['/28226e86-8f8e-4d79-b1fa-e1c155bc045c.jpg', '/ded68c06-c3a1-4dfa-a417-e025e5868f60.jpg'],
  ...
  {
    name: 'River Safari & Turtle Hatchery', category: 'Nature', image: '/09458834-a156-4b05-8dc9-c0c7c2c90a20.jpg',
    gallery: ['/09458834-a156-4b05-8dc9-c0c7c2c90a20.jpg'],
  ...
  {
    name: 'Udawalawe Elephant Safari', category: 'Wildlife', image: '/60b4c194-d3e8-44d7-8a8c-b9d58a908c56.jpg',
    gallery: ['/60b4c194-d3e8-44d7-8a8c-b9d58a908c56.jpg', '/1b2aae1b-d37a-47fe-9479-1d17002debd6.jpg'],
  ...
  return [
    {
      ...
      category: 'Honeymoon',
      tourType: 'Private',
      heroImage: '/e12be888-4561-43cf-b8a3-fb6d9de4b630.jpg',
      gallery: ['/e12be888-4561-43cf-b8a3-fb6d9de4b630.jpg', '/09458834-a156-4b05-8dc9-c0c7c2c90a20.jpg', '/5173712e-19bd-4ede-810a-b1fd443e9ef1.jpg', '/a11c5b41-970d-4c2e-bc21-b12bbb96bc44.jpg'],
    ...
    },
    {
      ...
      category: 'Scenic',
      tourType: 'Group',
      heroImage: '/28226e86-8f8e-4d79-b1fa-e1c155bc045c.jpg',
      gallery: ['/28226e86-8f8e-4d79-b1fa-e1c155bc045c.jpg', '/470f58a2-b8ec-4c53-b2fe-62c6f0cbb506.jpg', '/ded68c06-c3a1-4dfa-a417-e025e5868f60.jpg', '/e9d77ac4-d145-4b73-befe-f35b121bcb9f.jpg'],
    ...
    },
    {
      ...
      tourType: 'Group',
      heroImage: '/f1dc4405-8788-4026-86f6-8dcd6433d54c.jpg',
      gallery: ['/f1dc4405-8788-4026-86f6-8dcd6433d54c.jpg', '/8e639092-b4b2-41f6-ad69-0a4e0017609a.jpg', '/e9d77ac4-d145-4b73-befe-f35b121bcb9f.jpg'],
    ...
    },
    {
      ...
      category: 'Luxury',
      tourType: 'Private',
      heroImage: '/8e639092-b4b2-41f6-ad69-0a4e0017609a.jpg',
      gallery: ['/8e639092-b4b2-41f6-ad69-0a4e0017609a.jpg', '/f1dc4405-8788-4026-86f6-8dcd6433d54c.jpg', '/60b4c194-d3e8-44d7-8a8c-b9d58a908c56.jpg', '/5173712e-19bd-4ede-810a-b1fd443e9ef1.jpg', '/a11c5b41-970d-4c2e-bc21-b12bbb96bc44.jpg'],
    ...
    },
    {
      ...
      category: 'Signature',
      tourType: 'Group',
      heroImage: '/a11c5b41-970d-4c2e-bc21-b12bbb96bc44.jpg',
      gallery: ['/a11c5b41-970d-4c2e-bc21-b12bbb96bc44.jpg', '/f1dc4405-8788-4026-86f6-8dcd6433d54c.jpg', '/e9d77ac4-d145-4b73-befe-f35b121bcb9f.jpg', '/470f58a2-b8ec-4c53-b2fe-62c6f0cbb506.jpg'],
    ...
    },
    {
      ...
      category: 'Wildlife',
      tourType: 'Private',
      heroImage: '/60b4c194-d3e8-44d7-8a8c-b9d58a908c56.jpg',
      gallery: ['/60b4c194-d3e8-44d7-8a8c-b9d58a908c56.jpg', '/1b2aae1b-d37a-47fe-9479-1d17002debd6.jpg', '/09458834-a156-4b05-8dc9-c0c7c2c90a20.jpg'],
