...
function buildPackagesSeed(destMap, activityMap, hotelMap) {
  ...
  return [
    ...
    {
      name: '4-Day Sri Lanka Tour — Highlights of Sri Lank',
      category: 'Scenic',
      tourType: 'Private',
      heroImage: '/package-emerald-odyssey.jpg',
      gallery: ['/package-emerald-odyssey.jpg', '/package-romantic-escape.jpg'],
      destinations: dest(['Kandy', 'Nuwara Eliya', 'Bentota']),
      activities: acts(['Temple of the Tooth Tour', 'Tea Plantation Tours', 'River Safari & Turtle Hatchery']),
      hotels: [hotel('Kandy Lake Residence'), hotel('Taru Villas Bentota')].filter(Boolean),
      durationDays: 5,
      durationNights: 4,
      itinerary: [
        { dayNumber: 1, title: 'Airport to Kandy', description: 'Distance: 105–120 km. Travel Time: 3–4 hours. Meet your Roxaval Travels representative and travel to Kandy for the Temple of the Sacred Tooth Relic, a city tour, Kandy Lake and an optional Kandyan cultural dance performance.', destinations: dest(['Kandy']), activities: acts(['Temple of the Tooth Tour']), hotel: hotel('Kandy Lake Residence'), meals: [] },
        { dayNumber: 2, title: 'Kandy to Nuwara Eliya', description: 'Distance: 75–90 km. Travel Time: 3–4 hours. Visit the Royal Botanical Garden in Peradeniya, Ramboda Waterfalls, and a tea plantation and factory before arriving in colonial Nuwara Eliya.', destinations: dest(['Kandy', 'Nuwara Eliya']), activities: acts(['Tea Plantation Tours']), meals: ['Breakfast'] },
        { dayNumber: 3, title: 'Nuwara Eliya Tea Country', description: 'Distance: 20–35 km. Travel Time: 45–90 minutes. Explore Gregory Lake, Victoria Park, local markets and viewpoints amid the cool highland scenery.', destinations: dest(['Nuwara Eliya']), meals: ['Breakfast'] },
        { dayNumber: 4, title: 'Nuwara Eliya to Bentota', description: 'Distance: 220–240 km. Travel Time: 5.5–7 hours. Stop at Devon and St. Clair’s Falls, then enjoy a Madu River boat safari before unwinding on Bentota’s golden beach.', destinations: dest(['Nuwara Eliya', 'Bentota']), activities: acts(['River Safari & Turtle Hatchery']), hotel: hotel('Taru Villas Bentota'), meals: ['Breakfast'] },
        { dayNumber: 5, title: 'Bentota to Airport', description: 'Distance: 115–130 km. Travel Time: 3–4 hours. Travel via Colombo for optional sightseeing and souvenir shopping before your airport departure.', destinations: dest(['Bentota']), meals: ['Breakfast'] },
      ],
      includedServices: ['Private air-conditioned transport', 'Airport transfers', 'Accommodation as per itinerary', 'Sightseeing listed in the itinerary'],
      excludedServices: ['International flights', 'Visa fees', 'Travel insurance', 'Meals and optional activities unless stated'],
      description: 'A short, memorable Sri Lankan getaway combining Kandy’s heritage, misty tea country, waterfalls and relaxing beach time in Bentota.',
      highlights: ['Temple of the Sacred Tooth Relic', 'Ceylon tea plantation and factory visit', 'Gregory Lake and Nuwara Eliya', 'Madu River boat safari and Bentota beach'],
      price: 790,
      currency: 'USD', minTravelers: 2, maxTravelers: 6, rating: 4.8, reviewsCount: 0, status: 'published', isFeatured: true,
    },
    {
      name: '8-Day Sri Lanka Tour — Classic Sri Lanka',
      category: 'Best Seller',
      tourType: 'Private',
      heroImage: '/package-ancient-ceylon.jpg',
      gallery: ['/package-ancient-ceylon.jpg', '/package-emerald-odyssey.jpg'],
      destinations: dest(['Sigiriya', 'Polonnaruwa', 'Kandy', 'Nuwara Eliya', 'Ella', 'Bentota']),
      activities: acts(['Sigiriya Rock Climb', 'Temple of the Tooth Tour', 'Tea Plantation Tours', 'Scenic Train Journey', 'Little Adam’s Peak Hike', 'River Safari & Turtle Hatchery']),
      hotels: [hotel('Water Garden Sigiriya'), hotel('Kandy Lake Residence'), hotel('Ella Flower Garden Resort'), hotel('Taru Villas Bentota')].filter(Boolean),
      durationDays: 8,
      durationNights: 7,
      itinerary: [
        { dayNumber: 1, title: 'Arrival in Negombo', description: 'Distance: 10–15 km. Travel Time: 30–45 minutes. Transfer from the airport and enjoy a coastal city tour, including the Dutch Fort area and beach time.', meals: ['Dinner'] },
        { dayNumber: 2, title: 'Negombo to Sigiriya', description: 'Distance: 150–170 km. Travel Time: 4–5 hours. Visit Pinnawala Elephant Orphanage and experience traditional village life on a Sigiriya village tour.', destinations: dest(['Sigiriya']), hotel: hotel('Water Garden Sigiriya'), meals: ['Breakfast'] },
        { dayNumber: 3, title: 'Polonnaruwa, Minneriya and Dambulla', description: 'Distance: 110–140 km. Travel Time: 3–4 hours. Explore Polonnaruwa’s ancient ruins, take a Minneriya wildlife safari and visit Dambulla Cave Temple.', destinations: dest(['Polonnaruwa', 'Sigiriya']), hotel: hotel('Water Garden Sigiriya'), meals: ['Breakfast'] },
        { dayNumber: 4, title: 'Sigiriya to Kandy', description: 'Distance: 100–120 km. Travel Time: 3–4 hours. Stop at a Matale spice garden, gem museum, wood-carving centre and batik factory before the Temple of the Tooth and a Kandyan dance show.', destinations: dest(['Sigiriya', 'Kandy']), activities: acts(['Temple of the Tooth Tour']), hotel: hotel('Kandy Lake Residence'), meals: ['Breakfast'] },
        { dayNumber: 5, title: 'Kandy to Nuwara Eliya', description: 'Distance: 80–100 km. Travel Time: 3–4 hours. Visit Peradeniya Botanical Garden, Ramboda Waterfalls and a Ceylon tea factory before exploring Little England.', destinations: dest(['Kandy', 'Nuwara Eliya']), activities: acts(['Tea Plantation Tours']), meals: ['Breakfast'] },
        { dayNumber: 6, title: 'Scenic Train to Ella', description: 'Distance: 65 km by rail. Travel Time: 2.5–3.5 hours. Board the spectacular hill-country train from Nanu Oya through tea plantations, misty mountains and waterfalls.', destinations: dest(['Nuwara Eliya', 'Ella']), activities: acts(['Scenic Train Journey']), hotel: hotel('Ella Flower Garden Resort'), meals: ['Breakfast'] },
        { dayNumber: 7, title: 'Ella to Bentota', description: 'Distance: 230–260 km. Travel Time: 6–7 hours. Hike Little Adam’s Peak, enjoy ziplining, visit Ravana Cave and Ravana Waterfall, then continue to the beach.', destinations: dest(['Ella', 'Bentota']), activities: acts(['Little Adam’s Peak Hike']), hotel: hotel('Taru Villas Bentota'), meals: ['Breakfast'] },
        { dayNumber: 8, title: 'Bentota and Departure', description: 'Distance: 30–60 km. Travel Time: 1–2 hours. Cruise the Madu River, visit a turtle conservation centre and enjoy Bentota beach before your airport transfer.', destinations: dest(['Bentota']), activities: acts(['River Safari & Turtle Hatchery']), meals: ['Breakfast'] },
      ],
      includedServices: ['Private air-conditioned transport', 'Airport transfers', 'Accommodation as per itinerary', 'Sightseeing listed in the itinerary'],
      excludedServices: ['International flights', 'Visa fees', 'Travel insurance', 'Meals and optional activities unless stated'],
      description: 'An essential Sri Lanka circuit of ancient kingdoms, wildlife, sacred Kandy, tea-covered hills, Ella’s scenic railway and Bentota’s coast.',
      highlights: ['Pinnawala, Polonnaruwa and Dambulla', 'Minneriya wildlife safari', 'Scenic train journey to Ella', 'Madu River safari and turtle conservation visit'],
      price: 1490,
      currency: 'USD', minTravelers: 2, maxTravelers: 6, rating: 4.9, reviewsCount: 0, status: 'published', isFeatured: true,
    },
    {
      name: '12-Day Sri Lanka Tour — Ultimate Sri Lanka Experience',
      category: 'Luxury',
      tourType: 'Private',
      heroImage: '/package-beyond-paradise.jpg',
      gallery: ['/package-beyond-paradise.jpg', '/package-emerald-odyssey.jpg', '/package-ancient-ceylon.jpg'],
      destinations: dest(['Sigiriya', 'Ella', 'Nuwara Eliya', 'Kandy']),
      activities: acts(['Sigiriya Rock Climb', 'Scenic Train Journey', 'Little Adam’s Peak Hike', 'Tea Plantation Tours', 'Temple of the Tooth Tour']),
      hotels: [hotel('Water Garden Sigiriya'), hotel('Ella Flower Garden Resort'), hotel('Kandy Lake Residence')].filter(Boolean),
      durationDays: 12,
      durationNights: 11,
      itinerary: [
        { dayNumber: 1, title: 'Arrival to Sigiriya', description: 'Distance: 150–170 km. Travel Time: 4–5 hours. Visit Pinnawala Elephant Orphanage and enjoy a traditional Sigiriya village experience before checking in.', destinations: dest(['Sigiriya']), hotel: hotel('Water Garden Sigiriya'), meals: [] },
        { dayNumber: 2, title: 'Sigiriya and Minneriya Safari', description: 'Distance: 50–70 km. Travel Time: 1.5–2 hours. Climb Sigiriya Lion Rock Fortress, then head to Minneriya National Park for an elephant-focused wildlife safari.', destinations: dest(['Sigiriya']), activities: acts(['Sigiriya Rock Climb']), hotel: hotel('Water Garden Sigiriya'), meals: ['Breakfast'] },
        { dayNumber: 3, title: 'Pidurangala to Passikudah', description: 'Distance: 190–220 km. Travel Time: 5–6 hours. Take in Pidurangala’s panoramic views, enjoy an ethical elephant observation experience and continue to the east coast.', destinations: dest(['Sigiriya']), meals: ['Breakfast'] },
        { dayNumber: 4, title: 'Passikudah Beach', description: 'Distance: 10–20 km. Travel Time: 20–40 minutes. Enjoy calm turquoise waters, beach time and optional resort water sports.', meals: ['Breakfast'] },
        { dayNumber: 5, title: 'Passikudah Resort Leisure', description: 'Distance: 10–20 km. Travel Time: 20–40 minutes. A free day for swimming, beach walks, optional water sports or a spa experience.', meals: ['Breakfast'] },
        { dayNumber: 6, title: 'Passikudah to Ella', description: 'Distance: 250–280 km. Travel Time: 6–7 hours. Travel into the hill country via Ravana Waterfall and enjoy an exciting ziplining experience in Ella.', destinations: dest(['Ella']), hotel: hotel('Ella Flower Garden Resort'), meals: ['Breakfast'] },
        { dayNumber: 7, title: 'Ella Discovery', description: 'Distance: 15–25 km. Travel Time: 45–90 minutes. Visit Nine Arch Bridge and Little Adam’s Peak, then join a traditional Sri Lankan cooking experience.', destinations: dest(['Ella']), activities: acts(['Little Adam’s Peak Hike']), hotel: hotel('Ella Flower Garden Resort'), meals: ['Breakfast'] },
        { dayNumber: 8, title: 'Scenic Train to Nuwara Eliya', description: 'Distance: 60–70 km by rail. Travel Time: 2.5–3.5 hours. Ride through tea plantations and misty mountains to Nanu Oya, then explore Nuwara Eliya and the Old Post Office.', destinations: dest(['Ella', 'Nuwara Eliya']), activities: acts(['Scenic Train Journey']), meals: ['Breakfast'] },
        { dayNumber: 9, title: 'Nuwara Eliya Highlands', description: 'Distance: 30–45 km. Travel Time: 1.5–2 hours. Visit Gregory Lake, Moon Plains and Lover’s Leap Waterfall amid tea-covered hills.', destinations: dest(['Nuwara Eliya']), meals: ['Breakfast'] },
        { dayNumber: 10, title: 'Nuwara Eliya to Kandy', description: 'Distance: 100–120 km. Travel Time: 3.5–4.5 hours. Visit a tea estate, Ramboda Waterfalls and Ambuluwawa Tower before arriving in Kandy.', destinations: dest(['Nuwara Eliya', 'Kandy']), activities: acts(['Tea Plantation Tours']), hotel: hotel('Kandy Lake Residence'), meals: ['Breakfast'] },
        { dayNumber: 11, title: 'Kandy Cultural Discovery', description: 'Distance: 25–40 km. Travel Time: 1–1.5 hours. Explore Peradeniya Botanical Garden, a gem museum, Kandy Lake and the Temple of the Sacred Tooth Relic.', destinations: dest(['Kandy']), activities: acts(['Temple of the Tooth Tour']), hotel: hotel('Kandy Lake Residence'), meals: ['Breakfast'] },
        { dayNumber: 12, title: 'Kandy to Airport', description: 'Distance: 120–140 km. Travel Time: 3.5–4.5 hours. Stop at a spice garden and, time permitting, enjoy final Colombo sightseeing or shopping before departure.', destinations: dest(['Kandy']), meals: ['Breakfast'] },
      ],
      includedServices: ['Private air-conditioned transport', 'Airport transfers', 'Accommodation as per itinerary', 'Sightseeing listed in the itinerary'],
      excludedServices: ['International flights', 'Visa fees', 'Travel insurance', 'Meals and optional activities unless stated'],
      description: 'A 12-day private journey from Sri Lanka’s ancient heartland to the east coast, Ella, tea country and Kandy’s cultural treasures.',
      highlights: ['Sigiriya Lion Rock and Minneriya safari', 'Three nights of east-coast beach relaxation', 'Ella adventures and the iconic scenic train', 'Nuwara Eliya, tea country and Kandy heritage'],
      price: 2490,
      currency: 'USD', minTravelers: 2, maxTravelers: 6, rating: 5.0, reviewsCount: 0, status: 'published', isFeatured: true,
    },
    {
      ...
      tourType: 'Private',
      heroImage: '/package-ancient-ceylon.jpg',
      gallery: ['/package-ancient-ceylon.jpg', '/package-emerald-odyssey.jpg', '/package-wildlife-explorer.jpg'],
      destinations: dest(['Sigiriya', 'Nuwara Eliya', 'Ella', 'Yala', 'Mirissa', 'Bentota']),
      activities: acts(['Sigiriya Rock Climb', 'Tea Plantation Tours', 'Scenic Train Journey', 'Little Adam’s Peak Hike', 'Wildlife Safari', 'Whale Watching', 'River Safari & Turtle Hatchery']),
      hotels: [hotel('Water Garden Sigiriya'), hotel('Ella Flower Garden Resort'), hotel('Cinnamon Wild Yala'), hotel('Mirissa Beach Villas'), hotel('Taru Villas Bentota')].filter(Boolean),
      durationDays: 6,
      durationNights: 5,
      itinerary: [
        { dayNumber: 1, title: 'Arrival to Sigiriya', description: 'Distance: 180 km. Travel Time: 4–4.5 hours. Meet your personal chauffeur guide, visit Pinnawala Elephant Orphanage and enjoy a Sigiriya village tour with traditional local experiences and lunch.', destinations: dest(['Sigiriya']), hotel: hotel('Water Garden Sigiriya'), meals: ['Lunch'] },
        { dayNumber: 2, title: 'Sigiriya to Nuwara Eliya', description: 'Distance: 170 km. Travel Time: 5–5.5 hours. Climb Sigiriya Lion Rock, visit a Matale spice garden, Ramboda Waterfall and Labukele Tea Estate before arriving in Little England.', destinations: dest(['Sigiriya', 'Nuwara Eliya']), activities: acts(['Sigiriya Rock Climb', 'Tea Plantation Tours']), meals: ['Breakfast'] },
        { dayNumber: 3, title: 'Nuwara Eliya to Ella', description: 'Distance: 70 km by road plus rail. Travel Time: 2 hours by road plus 3–3.5 hours by train. Visit the Old Post Office and Lover’s Leap Waterfall before the celebrated Nanu Oya to Ella train journey.', destinations: dest(['Nuwara Eliya', 'Ella']), activities: acts(['Scenic Train Journey']), hotel: hotel('Ella Flower Garden Resort'), meals: ['Breakfast'] },
        { dayNumber: 4, title: 'Ella, Yala and Mirissa', description: 'Distance: 190 km. Travel Time: 5.5–6 hours including safari. Hike Little Adam’s Peak, visit Nine Arch Bridge and Ravana Waterfall, then take a Yala jeep safari before continuing to Mirissa.', destinations: dest(['Ella', 'Yala', 'Mirissa']), activities: acts(['Little Adam’s Peak Hike', 'Wildlife Safari']), hotel: hotel('Mirissa Beach Villas'), meals: ['Breakfast'] },
        { dayNumber: 5, title: 'Mirissa to Bentota', description: 'Distance: 140 km. Travel Time: 3–3.5 hours. Set out on a seasonal Mirissa whale-watching excursion, then travel the south coast for a Madu River boat safari and a beach-resort stay.', destinations: dest(['Mirissa', 'Bentota']), activities: acts(['Whale Watching', 'River Safari & Turtle Hatchery']), hotel: hotel('Taru Villas Bentota'), meals: ['Breakfast'] },
        { dayNumber: 6, title: 'Bentota, Colombo and Departure', description: 'Distance: 110 km. Travel Time: 2.5–3 hours. Take a guided Colombo city tour, including Independence Square, Gangaramaya Temple, Galle Face Green and Pettah Market, before airport departure.', destinations: dest(['Bentota']), meals: ['Breakfast'] },
      ],
      includedServices: ['Private air-conditioned vehicle and chauffeur guide', 'Airport transfers', 'Accommodation as per itinerary', 'Sightseeing listed in the itinerary'],
      excludedServices: ['International flights', 'Visa fees', 'Travel insurance', 'Meals and optional activities unless stated'],
      description: 'A six-day private tour spanning Sri Lanka’s cultural heartland, tea-covered highlands, iconic rail journey, wildlife and southern beaches.',
      highlights: ['Sigiriya village tour and Lion Rock Fortress', 'Nanu Oya to Ella scenic train journey', 'Yala National Park jeep safari', 'Mirissa whale watching and Madu River safari'],
      price: 1590,
      currency: 'USD', minTravelers: 2, maxTravelers: 6, rating: 4.9, reviewsCount: 0, status: 'published', isFeatured: true,
    },
    {
      ...
      tourType: 'Private',
      heroImage: '/package-romantic-escape.jpg',
      gallery: ['/package-romantic-escape.jpg', '/package-beyond-paradise.jpg', '/package-emerald-odyssey.jpg'],
      destinations: dest(['Sigiriya', 'Kandy', 'Nuwara Eliya', 'Ella', 'Yala', 'Mirissa', 'Galle', 'Bentota']),
      activities: acts(['Sigiriya Rock Climb', 'Temple of the Tooth Tour', 'Tea Plantation Tours', 'Scenic Train Journey', 'Little Adam’s Peak Hike', 'Wildlife Safari', 'Whale Watching', 'Galle Fort Walking Tour', 'River Safari & Turtle Hatchery']),
      hotels: [hotel('Water Garden Sigiriya'), hotel('Kandy Lake Residence'), hotel('Ella Flower Garden Resort'), hotel('Mirissa Beach Villas'), hotel('Jetwing Lighthouse Galle'), hotel('Taru Villas Bentota')].filter(Boolean),
      durationDays: 10,
      durationNights: 9,
      itinerary: [
        { dayNumber: 1, title: 'Arrival to Sigiriya', description: 'Distance: 165–175 km. Travel Time: 4–5 hours. Visit Pinnawala and enjoy a traditional Sigiriya village tour before a honeymoon room setup and romantic dinner.', destinations: dest(['Sigiriya']), hotel: hotel('Water Garden Sigiriya'), meals: ['Dinner'] },
        { dayNumber: 2, title: 'Sigiriya and Pidurangala Sunset', description: 'Distance: 20–30 km. Travel Time: 45–60 minutes. Climb Sigiriya Lion Rock, enjoy an ethical elephant observation experience and watch sunset from Pidurangala with private dining available.', destinations: dest(['Sigiriya']), activities: acts(['Sigiriya Rock Climb']), hotel: hotel('Water Garden Sigiriya'), meals: ['Breakfast', 'Dinner'] },
        { dayNumber: 3, title: 'Sigiriya to Kandy', description: 'Distance: 100–115 km. Travel Time: 3.5–4.5 hours. Visit Dambulla Cave Temple, a Matale spice garden and gem museum, then tour Kandy, the Temple of the Tooth and a Kandyan dance show.', destinations: dest(['Sigiriya', 'Kandy']), activities: acts(['Temple of the Tooth Tour']), hotel: hotel('Kandy Lake Residence'), meals: ['Breakfast', 'Dinner'] },
        { dayNumber: 4, title: 'Kandy to Nuwara Eliya', description: 'Distance: 90–110 km. Travel Time: 3.5–4.5 hours. Stroll Peradeniya Botanical Garden, visit Ambuluwawa Tower and Ramboda Waterfalls, then tour Labukele Tea Estate.', destinations: dest(['Kandy', 'Nuwara Eliya']), activities: acts(['Tea Plantation Tours']), meals: ['Breakfast'] },
        { dayNumber: 5, title: 'Scenic Train to Ella', description: 'Distance: 65 km by rail. Travel Time: 2.5–3 hours. Explore Nuwara Eliya and board the scenic train from Nanu Oya through tea plantations and misty mountains.', destinations: dest(['Nuwara Eliya', 'Ella']), activities: acts(['Scenic Train Journey']), hotel: hotel('Ella Flower Garden Resort'), meals: ['Breakfast'] },
        { dayNumber: 6, title: 'Ella Honeymoon Experience', description: 'Distance: 15–30 km. Travel Time: 45–90 minutes. Visit Nine Arch Bridge and Little Adam’s Peak, then enjoy ziplining, a cooking experience and a romantic sunset in Ella.', destinations: dest(['Ella']), activities: acts(['Little Adam’s Peak Hike']), hotel: hotel('Ella Flower Garden Resort'), meals: ['Breakfast'] },
        { dayNumber: 7, title: 'Ella to Mirissa via Yala', description: 'Distance: 190–220 km. Travel Time: 5–6 hours. Stop at Ravana Falls and join a Yala jeep safari before arriving at your Mirissa beachfront hotel for a candlelit dinner.', destinations: dest(['Ella', 'Yala', 'Mirissa']), activities: acts(['Wildlife Safari']), hotel: hotel('Mirissa Beach Villas'), meals: ['Breakfast', 'Dinner'] },
        { dayNumber: 8, title: 'Mirissa Honeymoon Leisure', description: 'Distance: 20–50 km. Travel Time: 45–90 minutes. Enjoy seasonal whale watching, beach time, optional spa treatments and a private candlelight honeymoon dinner.', destinations: dest(['Mirissa']), activities: acts(['Whale Watching']), hotel: hotel('Mirissa Beach Villas'), meals: ['Breakfast', 'Dinner'] },
        { dayNumber: 9, title: 'Mirissa to Bentota via Galle', description: 'Distance: 100–120 km. Travel Time: 2.5–3.5 hours. Explore UNESCO-listed Galle Fort, cruise the Madu River and visit a turtle conservation centre before a Bentota beach stay.', destinations: dest(['Mirissa', 'Galle', 'Bentota']), activities: acts(['Galle Fort Walking Tour', 'River Safari & Turtle Hatchery']), hotel: hotel('Taru Villas Bentota'), meals: ['Breakfast', 'Dinner'] },
        { dayNumber: 10, title: 'Bentota to Airport', description: 'Distance: 115–130 km. Travel Time: 3–4 hours. Travel through Colombo for final sightseeing and souvenir shopping before your airport departure.', destinations: dest(['Bentota']), meals: ['Breakfast'] },
      ],
      includedServices: ['Private air-conditioned vehicle and chauffeur guide', 'Airport transfers', 'Accommodation as per itinerary', 'Honeymoon room setups and private dinners where specified', 'Sightseeing listed in the itinerary'],
      excludedServices: ['International flights', 'Visa fees', 'Travel insurance', 'Meals and optional activities unless stated'],
      description: 'A romantic private escape blending ancient heritage, misty mountains, iconic train travel, wildlife safaris and intimate beach stays.',
      highlights: ['Sigiriya and Pidurangala sunset experience', 'Private honeymoon dinners and room setups', 'Scenic rail journey through tea country', 'Yala safari, Mirissa whale watching and Galle Fort'],
      price: 2990,
      currency: 'USD', minTravelers: 2, maxTravelers: 2, rating: 5.0, reviewsCount: 0, status: 'published', isFeatured: true,
    },
    {
...
async function seed() {
  ...
  for (const v of vehiclesSeed) {
    ...
    // eslint-disable-next-line no-await-in-loop
    await Vehicle.findOneAndUpdate({ slug }, { ...v, slug }, { upsert: true, new: true });
  }
